...
public class FragmentZ32 extends BaseFragment {
    Context context;
...
String sdCardPath = "/storage/emulated/0/Pictures";
    ...
    void drawText(Canvas canvas) {
        canvas.drawRect(200, 100, 200 + 300, 100 + 18, rectPaint);
        canvas.drawText(orderItems.get(currentID).sku + "   " + time + "  " + orderItems.get(currentID).order_number, 200, 100 + 16, paint);
    }
    ...
    public void remixx(){
        ...
        canvasCombine.drawRect(0, 0, 3620, 2493, rectBorderPaint);
        canvasCombine.drawRect(0, 0, 3618, 2491, rectBorderPaint);
