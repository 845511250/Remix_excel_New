...
public class FragmentGJ extends BaseFragment {
    Context context;
...
String sdCardPath = "/storage/emulated/0/Pictures";
    ...
    public void remixx(){
        ...
        Bitmap bitmapCombine = Bitmap.createBitmap(3472, 1677, Bitmap.Config.ARGB_8888);
        ...
        canvasCombine.drawText("GJ毛巾 " + time + "  " + orderItems.get(currentID).order_number, 20, 17 - 2, paint);
