...
public class FragmentHT extends BaseFragment {
    Context context;
...
String sdCardPath = "/storage/emulated/0/Pictures";
    ...
    public void remixx(){
        ...
        if (orderItems.get(currentID).sku.equals("HT2")) {
            ...
            bitmapCombine = Bitmap.createBitmap(471 + 120, 1417 + 120, Bitmap.Config.ARGB_8888);
            Canvas canvasCombine= new Canvas(bitmapCombine);
            canvasCombine.setDrawFilter(new PaintFlagsDrawFilter(0, Paint.ANTI_ALIAS_FLAG | Paint.FILTER_BITMAP_FLAG));
            canvasCombine.drawColor(0xffffffff);
...
//            bitmapCombine = Bitmap.createBitmap(bitmapCombine, 0, 0, bitmapCombine.getWidth(), bitmapCombine.getHeight(), matrix, true);
            ...
            String nameCombine = "吊牌" + orderItems.get(currentID).sku + "_" + orderItems.get(currentID).order_number + strPlus + ".jpg";
