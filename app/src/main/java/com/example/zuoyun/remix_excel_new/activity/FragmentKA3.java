...
public class FragmentKA3 extends BaseFragment {
    Context context;
...
String sdCardPath = "/storage/emulated/0/Pictures";
    ...
    void drawTextMain(Canvas canvas) {
        canvas.drawRect(6558, 195, 6558 + 500, 195 + 210, rectPaint);
        canvas.drawText(time, 6558, 195 + 50, paintRed);
        canvas.drawText(orderItems.get(currentID).sku + "  " + adult_child, 6558, 195 + 50 * 2, paintRed);
        canvas.drawText(orderItems.get(currentID).order_number, 6558, 195 + 50 * 3, paintRed);
        canvas.drawText("贴片红线边向下", 6558, 195 + 50 * 4, paintRed);
    }
    void drawTextMain2(Canvas canvas) {
        canvas.drawRect(20, 195, 20 + 500, 195 + 210, rectPaint);
        canvas.drawText(time, 20, 195 + 50, paintRed);
        canvas.drawText(orderItems.get(currentID).sku + "  " + adult_child, 20, 195 + 50 * 2, paintRed);
        canvas.drawText(orderItems.get(currentID).order_number, 20, 195 + 50 * 3, paintRed);
        canvas.drawText("贴片红线边向下", 20, 195 + 50 * 4, paintRed);
    }
    ...
    public void remixx(){
        ...
        //side
        Bitmap bitmapTemp = Bitmap.createBitmap(MainActivity.instance.bitmaps.get(0), 3237, 2685, 827, 591);
        ...
        //main
        bitmapTemp = Bitmap.createBitmap(MainActivity.instance.bitmaps.get(0), 89, 4002, 7122, 614);
