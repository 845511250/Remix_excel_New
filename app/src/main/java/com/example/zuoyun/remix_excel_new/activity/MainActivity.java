    ...
    void setfg(){
        ...
        switch (orderItems.get(currentID).sku) {
            ...
            case "AB":
                ...
                break;
            case "ABM":
                tv_title.setText("ABM拖鞋 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentAB());
                break;
            case "ABW":
                tv_title.setText("ABW拖鞋 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentAB());
                break;
            case "MENSAB":
                tv_title.setText("AB拖鞋 " + orderItems.get(currentID).order_number);
            ...
            case "AX":
                tv_title.setText("内裤 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentAX_JJ());
                break;
            case "AZ":
            ...
            case "D14":
                ...
                break;
            case "D18":
                tv_title.setText("D18 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentD18());
                break;
            case "D26":
                tv_title.setText("D26 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentD26());
                break;
            case "D40":
            ...
            case "F3":
                ...
                break;
            case "F8":
                tv_title.setText("F8 " + orderItems.get(currentID).order_number);
            ...
            case "FB":
                ...
                break;
            case "FC":
                tv_title.setText("FC " + orderItems.get(currentID).order_number);
            ...
            case "GQ":
                ...
                transaction.replace(R.id.frame_main, new FragmentGQ());
                break;
            case "GQM":
                tv_title.setText("男卫衣 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentGQ());
            ...
            case "GQW":
                ...
                break;
            case "GQY":
                tv_title.setText("儿童卫衣 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentGQ());
                break;
            case "GR":
                tv_title.setText("男卫衣 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentGR());
                break;
            case "GRM":
                tv_title.setText("男卫衣 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentGR());
            ...
            case "GRW":
                ...
                break;
            case "GRY":
                tv_title.setText("儿童拉链卫衣 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentGR());
                break;
            case "GS":
                tv_title.setText("卫衣裙 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentGS160());
                break;
            case "GT":
            ...
            case "HD":
                ...
                break;
            case "HF":
                tv_title.setText("HF " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentHF());
                break;
            case "HGM":
            ...
            case "HGW":
                ...
                break;
            case "HH":
                tv_title.setText("HH喇叭裙 " + orderItems.get(currentID).order_number);
            ...
            case "HO7":
                ...
                break;
            case "HS":
                tv_title.setText("HS灯罩 " + orderItems.get(currentID).order_number);
            ...
            case "HV":
                ...
                break;
            case "HU1":
                tv_title.setText("HU1 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentHU());
                break;
            case "HU2":
                tv_title.setText("HU2 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentHU());
                break;
            case "HU3":
                tv_title.setText("HU3 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentHU());
                break;
            case "HU4":
                tv_title.setText("HU4 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentHU());
                break;
            case "HU5":
                tv_title.setText("HU5 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentHU());
                break;
            case "HW":
            ...
            case "KK":
                ...
                break;
            case "KKY":
                tv_title.setText("KKY(MD鞋底高帮) " + orderItems.get(currentID).order_number);
            ...
            case "KL":
                ...
                break;
            case "KLY":
                tv_title.setText("KLY(MD鞋底低帮) " + orderItems.get(currentID).order_number);
            ...
            case "KO":
                ...
                break;
            case "KP":
                tv_title.setText("KP " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentKP());
                break;
            case "KR":
            ...
            case "LX":
                ...
                break;
            case "LZ":
                tv_title.setText("LZ洗手液瓶 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentLZ());
                break;
            case "MA":
            ...
            case "SF_F14":
                ...
                transaction.replace(R.id.frame_main, new FragmentSF_F14());
                break;
            case "SF_F21":
            ...
            case "W":
                ...
                break;
            case "X1":
                tv_title.setText("X1 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentX1());
                break;
            case "X2":
                tv_title.setText("X2 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentX2());
                break;
            case "X3":
                tv_title.setText("X3 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentX3());
                break;
            case "X4":
                tv_title.setText("X4 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentX4());
                break;
            case "X5":
                tv_title.setText("X5 " + orderItems.get(currentID).order_number);
                transaction.replace(R.id.frame_main, new FragmentX5());
                break;
            case "Z":
            ...
            for (int i = 0; i < rows; i++) {
                ...
                if (row != null && getContent(row, 0) != "" && getContent(row, 5).contains(".")) {
                    ...
                    if (!sizestr.equals("")) {
                        ...
                        orderItem.sizeStr = sizestr.replace("/", ".");
                    }

                    boolean isDifferentSKU = true;
                    if (SKU.equals("ABMEN") || SKU.equals("MENFLIPFLOP") || SKU.equals("ABWOMEN") || SKU.equals("WOMENFLIPFLOP"))
                        ...
                        orderItem.sku = "LH";
                    else if (SKU.equalsIgnoreCase("D17"))
                        orderItem.sku = "ME";
                    else if (SKU.equalsIgnoreCase("D19"))
                        orderItem.sku = "HZ";
                    else if (SKU.equalsIgnoreCase("D20"))
                        orderItem.sku = "LR";
                    else if (SKU.equalsIgnoreCase("D21"))
                        orderItem.sku = "Z70";
                        ...
                        orderItem.sku = "DT";
                    else if (SKU.equalsIgnoreCase("D32"))
                        orderItem.sku = "N";
                    else if (SKU.equalsIgnoreCase("D33"))
                        orderItem.sku = "CN";
                    else if (SKU.equalsIgnoreCase("D34"))
                        orderItem.sku = "GI";
                        ...
                        orderItem.sku = "Q";
                    else if (SKU.equalsIgnoreCase("D38"))
                        orderItem.sku = "R";
                        ...
                        orderItem.sku = "GH";
                    else if (SKU.equalsIgnoreCase("D63"))
                        orderItem.sku = "SF_F21";
                        ...
                        orderItem.sku = "LX";
                    else if (SKU.equalsIgnoreCase("SF_D90"))
                        orderItem.sku = "DL";
                    else if (SKU.equalsIgnoreCase("SF_D91"))
                        orderItem.sku = "DM";
                        ...
                        orderItem.sku = "Z8";
                    else if (SKU.equalsIgnoreCase("SF_D97"))
                        orderItem.sku = "Z9";
                    else if (SKU.equalsIgnoreCase("SF_F1"))
                        orderItem.sku = "HA";
                    else if (SKU.equalsIgnoreCase("SF_F2"))
                        orderItem.sku = "Z21";
                    else if (SKU.equalsIgnoreCase("SF_F3"))
                        orderItem.sku = "Z5";
                    else if (SKU.equalsIgnoreCase("SF_F5"))
                        orderItem.sku = "GQY";
                    ...
                    //保存的生产图名字
                    String name_AB, name_size, name_order;
                    if (orderItem.newCode.length() >= 6 && (orderItem.newCode.startsWith("A") || orderItem.newCode.startsWith("B"))) {
                        name_AB = orderItem.newCode.substring(0, 1);
                        if (orderItem.platform.endsWith("jj")) {
                            name_order = orderItem.newCode.substring(orderItem.newCode.lastIndexOf("-") + 1);
                        } else {
                            String str_sub = orderItem.newCode.substring(0, orderItem.newCode.lastIndexOf("-"));
                            name_order = str_sub.substring(str_sub.lastIndexOf("-") + 1) + orderItem.newCode.substring(orderItem.newCode.lastIndexOf("-"));
                        }
                    } else {
                        name_AB = "";
                        name_order = "";
                    }
                    if (orderItem.sizeStr.length() > 0 && orderItem.sizeStr.length() <= 5) {
                        name_size = orderItem.sizeStr;
                    } else {
                        name_size = "";
                    }
                    orderItem.nameStr = orderItem.sku + (isDifferentSKU ? "(" + SKU + ")" : "") + "-" + name_AB + "-" + name_size + "-" + orderItem.color + "-" + name_order + "-" + orderItem.order_number;
                    //南安UV机鞋子按码数排序
                    if (!orderItem.platform.endsWith("jj")) {
                    ...
                    if (orderItem.imgs.size() == 2) {
                        ...
                        if (orderItem.isPPSL && !orderItem.imgs.get(0).toLowerCase().contains("left")) {
                            String strTemp = orderItem.imgs.get(0);
                            orderItem.imgs.remove(0);
                            orderItem.imgs.add(strTemp);
                        }
