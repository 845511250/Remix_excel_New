...
public class FragmentZ28 extends BaseFragment {
    Context context;
...
String sdCardPath = "/storage/emulated/0/Pictures";
    ...
    public void remixx(){
        Bitmap bitmapCombine = Bitmap.createScaledBitmap(MainActivity.instance.bitmaps.get(0), 6144, 6144, true);
        Canvas canvasCombine= new Canvas(bitmapCombine);
        canvasCombine.setDrawFilter(new PaintFlagsDrawFilter(0, Paint.ANTI_ALIAS_FLAG | Paint.FILTER_BITMAP_FLAG));

        drawText(canvasCombine);
        canvasCombine.drawRect(0, 0, 6144, 6144, rectBorderPaint);
        canvasCombine.drawRect(2, 2, 6144 - 2, 6144 - 2, rectBorderPaint);
