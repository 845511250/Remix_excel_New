...
public class FragmentMB extends BaseFragment {
    Context context;
...
String sdCardPath = "/storage/emulated/0/Pictures";
    ...
    void drawText(Canvas canvas) {
        canvas.drawRect(100, 3, 100 + 300, 3 + 19, rectPaint);
        canvas.drawText(orderItems.get(currentID).nameStr + strPlus, 100, 3 + 17, paint);
    }
