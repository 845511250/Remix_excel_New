...
public class FragmentKA1 extends BaseFragment {
    Context context;
...
String sdCardPath = "/storage/emulated/0/Pictures";
    ...
    void drawTextMain(Canvas canvas) {
        canvas.save();
        canvas.rotate(-90, 2342, 428);
        canvas.drawRect(2342, 428, 2342 + 400, 428 + 200, rectPaint);
        canvas.drawText(orderItems.get(currentID).sku + " " + adult_child + " " + time, 2342, 428 + 50, paintRed);
        canvas.drawText(orderItems.get(currentID).order_number, 2342, 428 + 50 * 2, paintRed);
        canvas.restore();
    }
    ...
    public void remixx(){
        ...
        //side
        Bitmap bitmapTemp = Bitmap.createBitmap(MainActivity.instance.bitmaps.get(0), 1126, 744, 449, 449);
        ...
        //main
        bitmapTemp = Bitmap.createBitmap(MainActivity.instance.bitmaps.get(0), 122, 1484, 2457, 472);
